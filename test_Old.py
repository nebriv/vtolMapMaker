...
with open('outfile.xml', 'wb') as fd:
                ...
                if road['properties']['kind'] == "highway":
                    ...
                    for cords in road['geometry']['coordinates']:
                        if type(cords[0]) is not float:
                            ...
                            # print(cords)
                            for cord in cords:
                                road_data.append("%s,%s,%s,%s" % (cord[1], cord[0], "red", "square"))
                        else:
                            # print("not list")
                            # print(cords)
                            road_data.append("%s,%s,%s,%s" % (cords[1], cords[0], "red", "square"))
                ...
                if road['properties']['kind'] == "major_road":
                    ...
                    for cords in road['geometry']['coordinates']:
                        if type(cords[0]) is not float:
                            ...
                            # print(cords)
                            for cord in cords:
                                road_data.append("%s,%s,%s,%s" % (cord[1], cord[0], "blue", "square"))
                        else:
                            # print("not list")
                            # print(cords)
                            road_data.append("%s,%s,%s,%s" % (cords[1], cords[0], "blue", "square"))
...
##
for z in zoom:
   highways, majorRoads = getTiles(points, z)
